...
import com.fastoo.sdk.api.SendSmsApi;
import com.fastoo.sdk.model.SendSingleSmsParm;
import com.fastoo.sdk.model.ReturnModel;
import com.fastoo.sdk.model.SendBatchSmsParm;
/**
 * 测试--发送短信Api
 * @author lb
 * @version 1.0
...
public class SendSmsApiTest {
	...
	public static void TestSubmit(){
		ReturnModel bean=SendSmsApi.Submit("6201a8de233f419bb33e8951462b2432", "8615711586282,8613037372345", "您的验证码是421542");
		System.out.println("返回字符串："+bean.getJsonstr());
		System.out.println("code："+bean.getCode());
		System.out.println("msg："+bean.getMsg());
		if(bean.getCode().equals(0)){
